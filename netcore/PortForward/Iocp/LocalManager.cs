...
namespace PortForward.Iocp
{
    public class LocalManager
    {
        ...
        {
            var listener = new Iocp.TcpServer();
            listener.port = inputConn_Port;

            listener.Conn_OnConnected = OnInputConnected;
        ...
        private void OnInputConnected(TcpConn inputClient)
        {
            //Bridge
