...
namespace PortForward
{
    public class Commond
    {
        ...
        {
            #region print Help
            WriteLine("version:  1.9");
            WriteLine("author:  lith");
            WriteLine("email:   litsoft@126.com");
            WriteLine("----Lith端口转发----");
            ...
            WriteLine("     Demo:");
            WriteLine("         PortForwardLocal--8000--192.168.1.5--3384--NoPrint.exe");
            ...
            WriteLine("     Demo:");
            WriteLine("         PortForwardClient--authToken--192.168.1.100--6203--abc.com--3389--5");
            WriteLine("         PortForwardServer--authToken--6202--6203.exe");
            WriteLine("");
            WriteLine("     说明:");
